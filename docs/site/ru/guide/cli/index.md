...
| Команда                                                    | Что делает                                                                                                                       | Страница                             |
| ---------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| [`wolf analytics`](/ru/guide/cli/analytics#wolf-analytics) | Аналитика эффективности: ledger'ы памяти/инструментов/правил, воронка, агенты, steward view, выбросы, готовность к экспериментам | [Аналитика](/ru/guide/cli/analytics) |
