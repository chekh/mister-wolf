...
| `MEMORY.md` / `docs/user-guide.md` / `README.md`        | Update command examples.                                 |
...
rg 'wolf memory ' README.md MEMORY.md docs/user-guide.md
```
...
Add to `MEMORY.md` section on rules:
...
```bash
git add README.md MEMORY.md docs/user-guide.md
