"""Домен shipments: эндпоинты на swiftframe (мигрировано с miniframe)."""
...
def register(app: sf.SwiftApp) -> None:
    ...
    def create(req: sf.Request) -> sf.Reply:
        ...
        data = validate(req.body, FIELDS_SHIPMENTS, partial=False)
    ...
    def patch_one(req: sf.Request) -> sf.Reply:
        ...
        changes = validate(req.body, FIELDS_SHIPMENTS, partial=True)
